sap.ui.define([
	...
	"sap/m/MessageBox"
], function (BaseController, JSONModel, formatter, Filter, FilterOperator, History, MessageBox) {
	"use strict";
	...
	return BaseController.extend("sapui5.demo.worklist.controller.Worklist", {
		...
		onPress: function (oEvent) {
			var audio = new Audio(this._getFullSoundName("nav_forward"));
			audio.play();
		...
		showErrorMessage: function () {
			var audio = new Audio(this._getFullSoundName("message_popup")); //Audio("soundEffects/message_popup.wav");
			audio.play();
			var that = this;
			MessageBox.error("NNNNNNNNOOOOOOOOOOOOOOO!!!!!!!!!", {
				onClose: function(){
					var audio = new Audio(that._getFullSoundName("close_popup"));
					audio.play();
				}
			});
		},
